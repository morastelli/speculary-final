        ...
        <section>
            <div class="container">  
                ...
                <div class="select-image">
                    <img src="images/oculosdesolhoje4.jpg">
                </div>
            </div>
        </div>
                ...
                <div class="content">
                    <h6>ÓCULOS DE SOL</h6>
                    <h1>Óculos De Sol Para Festa Unissex Envolver Em Torno Y2K</h1>
                    <p>nova coleção</p>
                    <div class="prices">
                    <span class="price">$105,00</span>
                    <span class="off">$123,90</span>
                    </div>
                    <div class="options">
                    <form action="paginadeprodutosdesol5.php" method="post">
                          ...
                          if(isset($_POST["update"]))
                          {
                            ...
                            $comando = $pdo->prepare("UPDATE produtos SET carrinho=1, quantidade='$quantidade' WHERE id_produto = 23;");
                    ...
                    <form action="paginadeprodutosdesol5.php" method="post">
                      ...
                      <?php
                          ...
                          {
                            $quantidade = $_POST["quantidade"];
                            $comando = $pdo->prepare("UPDATE produtos SET favoritos=1, quantidade='$quantidade' WHERE id_produto = 23;");
                            $resultado = $comando->execute();
