        ...
        <section>
            <div class="container">
                ...
                <div class="select-image">
                    <img src="images/lentehoje22.jpg">
                </div>
            </div>
        </div>
                ...
                <div class="content">
                    ...
                    <h1> Caixa de Lentes de Contato Bioview 55 Asférica</h1>
                    <p>novidade</p>
                    <div class="prices">
                    <span class="price">$138,90</span>
                    <span class="off">$160,00</span>
                    </div>
                    <div class="options">
                    <form action="paginadeprodutosdelente3.php" method="post">
                          ...
                          if(isset($_POST["update"]))
                          {
                            ...
                            $comando = $pdo->prepare("UPDATE produtos SET carrinho=1, quantidade='$quantidade' WHERE id_produto = 15;");
                    ...
                    <form action="paginadeprodutosdelente3.php" method="post">
                      ...
                      <?php
                          ...
                          {
                            $quantidade = $_POST["quantidade"];
                            $comando = $pdo->prepare("UPDATE produtos SET favoritos=1, quantidade='$quantidade' WHERE id_produto = 15;");
                            $resultado = $comando->execute();
