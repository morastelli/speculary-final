        ...
        <section>
            <div class="container">
                ...
                <div class="content">
                    ...
                    <h1>Caixa de Lentes de contato SofLens59 6 unidades</h1>
                    <p>em estoque</p>
                    <div class="prices">
                    <span class="price">$119,90</span>
                    <span class="off">$135,90</span>
                    </div>
                    <div class="options">
                    <form action="paginadeprodutosdelente2.php" method="post">
                          ...
                          if(isset($_POST["update"]))
                          {
                            ...
                            $comando = $pdo->prepare("UPDATE produtos SET carrinho=1, quantidade='$quantidade' WHERE id_produto = 14;");
                    ...
                    <form action="paginadeprodutosdelente2.php" method="post">
                      ...
                      <?php
                          ...
                          {
                            $quantidade = $_POST["quantidade"];
                            $comando = $pdo->prepare("UPDATE produtos SET favoritos=1, quantidade='$quantidade' WHERE id_produto = 14;");
                            $resultado = $comando->execute();
