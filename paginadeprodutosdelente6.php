        ...
        <section>
            <div class="container">
                ...
                <div class="content">
                    ...
                    <h1>Caixa de Lentes de Contato Ultra (Bausch + Lomb)</h1>
                    <p>em estoque</p>
                    <div class="prices">
                    <span class="price">$175,00</span>
                    <span class="off">$189,90</span>
                    </div>
                    <div class="options">
                    <form action="paginadeprodutosdelente6.php" method="post">
                          ...
                          if(isset($_POST["update"]))
                          {
                            ...
                            $comando = $pdo->prepare("UPDATE produtos SET carrinho=1, quantidade='$quantidade' WHERE id_produto = 18;");
                    ...
                    <form action="paginadeprodutosdelente6.php" method="post">
                      ...
                      <?php
                          ...
                          {
                            $quantidade = $_POST["quantidade"];
                            $comando = $pdo->prepare("UPDATE produtos SET favoritos=1, quantidade='$quantidade' WHERE id_produto = 18;");
                            $resultado = $comando->execute();
