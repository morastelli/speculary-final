        ...
        <section>
            <div class="container">
                ...
                <div class="select-image">
                    <img class="sombra" src="images/armacao6.jpg">
                </div>
            </div>
        </div>
                ...
                <div class="content">
                    <h6>ARMAÇÃO</h6>
                    <h1>Armação Feminina Semicircular cor Marrom</h1>
                    <p>poucas unidades</p>
                    <div class="prices">
                    ...
                    <form action="paginadeprodutosarmacao1.php" method="post">
                          ...
                          if(isset($_POST["update"]))
                          {
                            ...
                            $comando = $pdo->prepare("UPDATE produtos SET carrinho=1, quantidade='$quantidade' WHERE id_produto = 1;");
