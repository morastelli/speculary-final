      ...
      <center>
        <section>
            <div class="container">
                ...
                <div class="content">
                    <h6>ARMAÇÃO</h6>
                    <h1>Armação Feminina Lux Fashion Apoena </h1>
                    <p>poucas unidades</p>
                    <div class="prices">
                    <span class="price">$75,90</span>
                    <span class="off">$85,90</span>
                    </div>
                    <div class="options">
                    <form action="paginadeprodutosarmacao6.php" method="post">
                          ...
                          if(isset($_POST["update"]))
                          {
                            ...
                            $comando = $pdo->prepare("UPDATE produtos SET carrinho=1, quantidade='$quantidade' WHERE id_produto = 6;");
                      ...
                      <?php
                          ...
                          {
                            $quantidade = $_POST["quantidade"];
                            $comando = $pdo->prepare("UPDATE produtos SET favoritos=1, quantidade='$quantidade' WHERE id_produto = 6;");
                            $resultado = $comando->execute();
