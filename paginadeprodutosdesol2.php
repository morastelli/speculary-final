        ...
        <section>
            <div class="container">
                ...
                <div class="select-image">
                    <img src="images/oculosdesolhoje.jpg">
                </div>
            </div>
        </div>
                ...
                <div class="content">
                    <h6>ÓCULOS DE SOL</h6>
                    <h1>Óculos feminino em formato quadrado tipo vintage</h1>
                    <p>poucas unidades</p>
                    <div class="prices">
                    ...
                    <div class="options">
                    <form action="paginadeprodutosdesol2.php" method="post">
                          ...
                          if(isset($_POST["update"]))
                          {
                            ...
                            $comando = $pdo->prepare("UPDATE produtos SET carrinho=1, quantidade='$quantidade' WHERE id_produto = 20;");
                    ...
                    <form action="paginadeprodutosdesol2.php" method="post">
                      ...
                      <?php
                          ...
                          {
                            $quantidade = $_POST["quantidade"];
                            $comando = $pdo->prepare("UPDATE produtos SET favoritos=1, quantidade='$quantidade' WHERE id_produto = 20;");
                            $resultado = $comando->execute();
