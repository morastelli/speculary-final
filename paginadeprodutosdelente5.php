        ...
        <section>
            <div class="container">
                ...
                <div class="select-image">
                    <img src="images/lentehojeeeeee.jpg">
                </div>
            </div>
        </div>
                ...
                <div class="content">
                    ...
                    <h1> Caixa com 3 lentes (1.5 pares) do mesmo grau Biosoft Tórica</h1>
                    <p>Coleção Nova</p>
                    <div class="prices">
                    <span class="price">$139,00</span>
                    <span class="off">$159,00</span>
                    </div>
                    <div class="options">
                    <form action="paginadeprodutosdelente5.php" method="post">
                          ...
                          if(isset($_POST["update"]))
                          {
                            ...
                            $comando = $pdo->prepare("UPDATE produtos SET carrinho=1, quantidade='$quantidade' WHERE id_produto = 17;");
                    ...
                    <form action="paginadeprodutosdelente5.php" method="post">
                      ...
                      <?php
                          ...
                          {
                            $quantidade = $_POST["quantidade"];
                            $comando = $pdo->prepare("UPDATE produtos SET favoritos=1, quantidade='$quantidade' WHERE id_produto = 17;");
                            $resultado = $comando->execute();
