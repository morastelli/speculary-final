        ...
        <section>
            <div class="container">
                ...
                <div class="content">
                    ...
                    <h1>Óculos feminino com armação em formato circular oldschool marrom</h1>
                    <p>poucas unidades</p>
                    <div class="prices">
                    ...
                    <div class="options">
                    <form action="paginadeprodutosdegrau1.php" method="post">
                          ...
                          if(isset($_POST["update"]))
                          {
                            ...
                            $comando = $pdo->prepare("UPDATE produtos SET carrinho=1, quantidade='$quantidade' WHERE id_produto = 7;");
                        ...
                        <form action="paginadeprodutosdegrau1.php" method="post">
                          ...
                          <?php
                              ...
                              {
                                $quantidade = $_POST["quantidade"];
                                $comando = $pdo->prepare("UPDATE produtos SET favoritos=1, quantidade='$quantidade' WHERE id_produto = 7;");
                                $resultado = $comando->execute();
