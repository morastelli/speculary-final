        ...
        <section>
            <div class="container">
                ...
                <div class="select-image">
                    <img src="images/armacaohoje44.jpg">
                </div>
            </div>
        </div>
                ...
                <div class="content">
                    <h6>ARMAÇÃO</h6>
                    <h1>Armação de óculos Titanium /Flexível Og / Fio de nylon/ Leve + Estojo</h1>
                    <p>em estoque</p>
                    <div class="prices">
                    <span class="price">$139,90</span>
                    <span class="off">$159,90</span>
                    </div>
                    <div class="options">
                    <form action="paginadeprodutosarmacao5.php" method="post">
                          ...
                          if(isset($_POST["update"]))
                          {
                            ...
                            $comando = $pdo->prepare("UPDATE produtos SET carrinho=1, quantidade='$quantidade' WHERE id_produto = 5;");
                      ...
                      <?php
                          ...
                          {
                            $quantidade = $_POST["quantidade"];
                            $comando = $pdo->prepare("UPDATE produtos SET favoritos=1, quantidade='$quantidade' WHERE id_produto = 5;");
                            $resultado = $comando->execute();
