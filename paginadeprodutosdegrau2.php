        ...
        <section>
            <div class="container">
                ...
                <div class="select-image">
                    <img src="images/oculosdegrauhoje.jpg">
                </div>
            </div>
        </div>
                ...
                <div class="content">
                    ...
                    <h1>Óculos feminino com moldura redonda</h1>
                    <p>nova coleção</p>
                    <div class="prices">
                    ...
                    <div class="options">
                    <form action="paginadeprodutosdegrau2.php" method="post">
                          ...
                          if(isset($_POST["update"]))
                          {
                            ...
                            $comando = $pdo->prepare("UPDATE produtos SET carrinho=1, quantidade='$quantidade' WHERE id_produto = 8;");
                      ...
                      <?php
                          ...
                          {
                            $quantidade = $_POST["quantidade"];
                            $comando = $pdo->prepare("UPDATE produtos SET favoritos=1, quantidade='$quantidade' WHERE id_produto = 8;");
                            $resultado = $comando->execute();
