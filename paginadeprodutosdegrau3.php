        ...
        <section>
            <div class="container">
                ...
                <div class="select-image">
                    <img src="images/oculosdegrauhoje3.jpg">
                </div>
            </div>
        </div>
                ...
                <div class="content">
                    ...
                    <h1> Óculos de Grau Unissex Juvenil Formato Redondo</h1>
                    <p>Últimas Unidades</p>
                    <div class="prices">
                    <span class="price">$120,00</span>
                    <span class="off">$135,00</span>
                    </div>
                    <div class="options">
                    <form action="paginadeprodutosdegrau3.php" method="post">
                          ...
                          if(isset($_POST["update"]))
                          {
                            ...
                            $comando = $pdo->prepare("UPDATE produtos SET carrinho=1, quantidade='$quantidade' WHERE id_produto = 9;");
                      ...
                      <?php
                          ...
                          {
                            $quantidade = $_POST["quantidade"];
                            $comando = $pdo->prepare("UPDATE produtos SET favoritos=1, quantidade='$quantidade' WHERE id_produto = 9;");
                            $resultado = $comando->execute();
