        ...
        <section>
            <div class="container">
                ...
                <div class="select-image">
                    <img src="images/oculosdesolhoje2.jpg">
                </div>
            </div>
        </div>
                ...
                <div class="content">
                    <h6>ÓCULOS DE SOL</h6>
                    <h1>3 Pares de Óculos de sol moldura quadrada fashionable</h1>
                    <p>poucas unidades</p>
                    <div class="prices">
                    <span class="price">$125,00</span>
                    <span class="off">$150,00</span>
                    </div>
                    <div class="options">
                    <form action="paginadeprodutosdesol3.php" method="post">
                          ...
                          if(isset($_POST["update"]))
                          {
                            ...
                            $comando = $pdo->prepare("UPDATE produtos SET carrinho=1, quantidade='$quantidade' WHERE id_produto = 21;");
                    ...
                    <form action="paginadeprodutosdesol3.php" method="post">
                      ...
                      <?php
                          ...
                          {
                            $quantidade = $_POST["quantidade"];
                            $comando = $pdo->prepare("UPDATE produtos SET favoritos=1, quantidade='$quantidade' WHERE id_produto = 21;");
                            $resultado = $comando->execute();
