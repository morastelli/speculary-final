        ...
        <section>
            <div class="container">
                ...
                <div class="select-image">
                    <img src="images/armacaohoje33.jpg">
                </div>
            </div>
        </div>
                ...
                <div class="content">
                    <h6>ARMAÇÃO</h6>
                    <h1>Armação Masculino Cor Azul em formato Quadrado</h1>
                    <p>poucas unidades</p>
                    <div class="prices">
                    <span class="price">$55,00</span>
                    <span class="off">$65,00</span>
                    </div>
                    <div class="options">
                    <form action="paginadeprodutosarmacao4.php" method="post">
                          ...
                          if(isset($_POST["update"]))
                          {
                            ...
                            $comando = $pdo->prepare("UPDATE produtos SET carrinho=1, quantidade='$quantidade' WHERE id_produto = 4;");
                      ...
                      <?php
                          ...
                          {
                            $quantidade = $_POST["quantidade"];
                            $comando = $pdo->prepare("UPDATE produtos SET favoritos=1, quantidade='$quantidade' WHERE id_produto = 4;");
                            $resultado = $comando->execute();
