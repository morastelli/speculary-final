        ...
        <section>
            <div class="container">
                ...
                <div class="content">
                    ...
                    <div class="options">
                    <form action="paginadeprodutosarmacao3.php" method="post">
                          ...
                          if(isset($_POST["update"]))
                          {
                            ...
                            $comando = $pdo->prepare("UPDATE produtos SET carrinho=1, quantidade='$quantidade' WHERE id_produto = 3;");
                      ...
                      <?php
                          ...
                          {
                            $quantidade = $_POST["quantidade"];
                            $comando = $pdo->prepare("UPDATE produtos SET favoritos=1, quantidade='$quantidade' WHERE id_produto = 3;");
                            $resultado = $comando->execute();
