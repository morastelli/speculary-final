        ...
        <section>
            <div class="container">
                ...
                <div class="select-image">
                    <img src="images/oculosdegrau4.jpg">
                </div>
            </div>
        </div>
                ...
                <div class="content">
                    ...
                    <h1> Óculos de Grau Unissex Formato Hexagonal com Lente de Descanso Proteção UV400</h1>
                    <p>Coleção Nova</p>
                    <div class="prices">
                    ...
                    <div class="options">
                    <form action="paginadeprodutosdegrau4.php" method="post">
                          ...
                          if(isset($_POST["update"]))
                          {
                            ...
                            $comando = $pdo->prepare("UPDATE produtos SET carrinho=1, quantidade='$quantidade' WHERE id_produto = 10;");
                      ...
                      <?php
                          ...
                          {
                            $quantidade = $_POST["quantidade"];
                            $comando = $pdo->prepare("UPDATE produtos SET favoritos=1, quantidade='$quantidade' WHERE id_produto = 10;");
                            $resultado = $comando->execute();
