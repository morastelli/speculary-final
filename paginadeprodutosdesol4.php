        ...
        <section>
            <div class="container">
                ...
                <div class="select-image">
                    <img src="images/oculosdesolhoje3.jpg">
                </div>
            </div>
        </div>
                ...
                <div class="content">
                    <h6>ÓCULOS DE SOL</h6>
                    <h1>2 pares Óculos de sol detalhe rebite</h1>
                    <p>nova coleção</p>
                    <div class="prices">
                    ...
                    <form action="paginadeprodutosdesol4.php" method="post">
                          ...
                          if(isset($_POST["update"]))
                          {
                            ...
                            $comando = $pdo->prepare("UPDATE produtos SET carrinho=1, quantidade='$quantidade' WHERE id_produto = 22;");
                    ...
                    <form action="paginadeprodutosdesol4.php" method="post">
                      ...
                      <?php
                          ...
                          {
                            $quantidade = $_POST["quantidade"];
                            $comando = $pdo->prepare("UPDATE produtos SET favoritos=1, quantidade='$quantidade' WHERE id_produto = 22;");
                            $resultado = $comando->execute();
