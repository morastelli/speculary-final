      ...
      <center>
        <section>
            <div class="container">
                ...
                <div class="content">
                    <h6>ÓCULOS DE SOL</h6>
                    <h1>Óculos feminino com armação em formato triangular vintage</h1>
                    <p>poucas unidades</p>
                    <div class="prices">
                    ...
                    <div class="options">
                    <form action="paginadeprodutosdesol1.php" method="post">
                          ...
                          if(isset($_POST["update"]))
                          {
                            ...
                            $comando = $pdo->prepare("UPDATE produtos SET carrinho=1, quantidade='$quantidade' WHERE id_produto = 19;");
                    ...
                    <form action="paginadeprodutosdesol1.php" method="post">
                      ...
                      <?php
                          ...
                          {
                            $quantidade = $_POST["quantidade"];
                            $comando = $pdo->prepare("UPDATE produtos SET favoritos=1, quantidade='$quantidade' WHERE id_produto = 19;");
                            $resultado = $comando->execute();
