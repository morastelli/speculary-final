        ...
        <section>
            <div class="container"> 
                ...
                <div class="content">
                    ...
                    <h1>Óculos de Grau Feminino Borboleta com Cores de Onça</h1>
                    <p>em estoque</p>
                    <div class="prices">
                    <span class="price">$125,00</span>
                    <span class="off">$138,90</span>
                    </div>
                    <div class="options">
                    <form action="paginadeprodutosdegrau6.php" method="post">
                          ...
                          if(isset($_POST["update"]))
                          {
                            ...
                            $comando = $pdo->prepare("UPDATE produtos SET carrinho=1, quantidade='$quantidade' WHERE id_produto = 12;");
                    ...
                    <form action="paginadeprodutosdegrau6.php" method="post">
                      ...
                      <?php
                          ...
                          {
                            $quantidade = $_POST["quantidade"];
                            $comando = $pdo->prepare("UPDATE produtos SET favoritos=1, quantidade='$quantidade' WHERE id_produto = 12;");
                            $resultado = $comando->execute();
