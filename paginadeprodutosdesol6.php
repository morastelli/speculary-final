      ...
      <center>
        <section>
            <div class="container"> 
                ...
                <div class="content">
                    <h6>ÓCULOS DE SOL</h6>
                    <h1>Óculos de sol Unissex de Metal hexagonal</h1>
                    <p>Novidade</p>
                    <div class="prices">
                    <span class="price">$118,90</span>
                    <span class="off">$130,90</span>
                    </div>
                    <div class="options">
                    <form action="paginadeprodutosdesol6.php" method="post">
                          ...
                          if(isset($_POST["update"]))
                          {
                            ...
                            $comando = $pdo->prepare("UPDATE produtos SET carrinho=1, quantidade='$quantidade' WHERE id_produto = 24;");
                    ...
                    <form action="paginadeprodutosdesol6.php" method="post">
                      ...
                      <?php
                          ...
                          {
                            $quantidade = $_POST["quantidade"];
                            $comando = $pdo->prepare("UPDATE produtos SET favoritos=1, quantidade='$quantidade' WHERE id_produto = 24;");
                            $resultado = $comando->execute();
